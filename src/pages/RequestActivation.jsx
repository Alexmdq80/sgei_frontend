...
/**
 * Página para solicitar el reenvío del email de activación (para usuarios invitados).
 */
const RequestActivation = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.error("Error solicitando activación:", err);
            const errorMsg = err.response?.data?.message || err.response?.data?.error || 'No se pudo procesar la solicitud.';
        ...
        <div className="min-h-screen flex items-center justify-center bg-secondary-100 px-4 font-sans">
            <div className="max-w-md w-full bg-white rounded-2xl shadow-xl border border-secondary-200 p-8 md:p-10 animate-fadeIn">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-3xl font-extrabold text-secondary-900 tracking-tight leading-tight">Activa tu cuenta</h1>
                    <p className="text-secondary-500 mt-2 font-medium">Si fuiste invitado al sistema, ingresa tu email para recibir un nuevo enlace de activación.</p>
                </div>
                ...
                {status.success ? (
                    <div className="space-y-6 text-center animate-scaleIn">
                        <div className="bg-green-50 border border-green-200 rounded-2xl p-6">
                            ...
                            <h2 className="text-lg font-bold text-green-800 mb-1">¡Invitación enviada!</h2>
                            <p className="text-sm text-green-700 font-medium">Hemos enviado el enlace de activación a <span className="font-bold underline">{email}</span>. Recuerda revisar tu bandeja de spam.</p>
                        </div>
