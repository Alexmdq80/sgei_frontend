...
const DocumentoSituacionManagement = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            setIsSaving(true);
            if (editingItem) {
                await documentoSituacionService.update(editingItem.id, formData);
                showNotification('Situación actualizada correctamente.', 'success');
            } else {
                await documentoSituacionService.create(formData);
                showNotification('Situación creada correctamente.', 'success');
            }
            fetchData();
    ...
    const handleDelete = (id) => {
        setConfirmConfig({
            ...
            onConfirm: async () => {
                try {
                    await documentoSituacionService.delete(id);
    ...
    return (
        <div className="container mx-auto px-4 py-6">
            <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                <div>
                    <h1 className="text-2xl font-bold text-secondary-900">Situaciones de Documento</h1>
                    <p className="text-sm font-medium text-secondary-500">Administra los estados posibles de la documentación de las personas.</p>
                </div>
                <button
                            ...
                            <div className="px-8 pt-8 pb-6">
                                <div className="flex items-center justify-between mb-6">
                                    <h3 className="text-xl font-bold text-secondary-900">
                                        {editingItem ? 'Editar Situación' : 'Nueva Situación'}
                                    </h3>
                                    <button 
                                        type="button"
                                ...
                                <div className="space-y-5">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            placeholder="Ej: Presentado, Pendiente, En Trámite"
                                        />
                                    </div>
                                    ...
                                    <div className="flex items-center gap-3 p-4 bg-secondary-50 border border-secondary-200 rounded-xl">
                                        ...
                                        <label htmlFor="vigente-toggle" className="text-sm font-bold text-secondary-700 cursor-pointer select-none">
                                            Situación Vigente
                                        </label>
                                    </div>
                                </div>
...
export default DocumentoSituacionManagement;
