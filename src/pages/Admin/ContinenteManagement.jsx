...
const ContinenteManagement = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            setIsSaving(true);
            if (editingItem) {
                await continenteService.update(editingItem.id, formData);
                showNotification('Continente actualizado correctamente.', 'success');
            } else {
                await continenteService.create(formData);
                showNotification('Continente creado correctamente.', 'success');
            }
            fetchData();
    ...
    const handleDelete = (id) => {
        setConfirmConfig({
            ...
            onConfirm: async () => {
                try {
                    await continenteService.delete(id);
    ...
    return (
        <div className="container mx-auto px-4 py-6">
            <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                <div>
                    <h1 className="text-2xl font-bold text-secondary-900">Gestión de Continentes</h1>
                    <p className="text-sm font-medium text-secondary-500">Administra los continentes del mundo para la geolocalización.</p>
                </div>
                <button
                            ...
                            <div className="px-8 pt-8 pb-6">
                                <div className="flex items-center justify-between mb-6">
                                    <h3 className="text-xl font-bold text-secondary-900">
                                        {editingItem ? 'Editar Continente' : 'Nuevo Continente'}
                                    </h3>
                                    <button 
                                        type="button"
                                ...
                                <div className="space-y-5">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            placeholder="Ej: América, Europa, África..."
                                        />
                                    </div>
                                    ...
                                    <div className="flex items-center gap-3 p-4 bg-secondary-50 border border-secondary-200 rounded-xl">
                                        ...
                                        <label htmlFor="vigente-toggle-cont" className="text-sm font-bold text-secondary-700 cursor-pointer select-none">
                                            Continente Vigente
                                        </label>
                                    </div>
                                </div>
...
export default ContinenteManagement;
