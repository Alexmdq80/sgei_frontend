                            ...
                            {isLoading ? (
                                ...
                                items.map((item) => (
                                    <tr key={item.id} className="hover:bg-secondary-50/50 transition-colors group">
                                        ...
                                        <td className="px-6 py-4 text-sm text-secondary-600 font-mono uppercase">{item.iso_id || '-'}</td>
                                ...
                                <tr>
                                    <td colSpan="5" className="px-6 py-12 text-center text-secondary-500 font-medium">No se encontraron provincias.</td>
                                </tr>
                            )}
                        </tbody>
                    </table>
                ...
                {!isLoading && pagination.last_page > 1 && (
                    <div className="px-6 py-4 bg-secondary-50/50 border-t border-secondary-100 flex items-center justify-between">
                        <p className="text-xs text-secondary-500 font-medium">
                            Mostrando <span className="font-bold text-secondary-700">{pagination.from}</span> a <span className="font-bold text-secondary-700">{pagination.to}</span> de <span className="font-bold text-secondary-700">{pagination.total}</span> provincias
                        </p>
