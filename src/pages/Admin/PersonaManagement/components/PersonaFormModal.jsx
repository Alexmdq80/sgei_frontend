...
export default function PersonaFormModal({
  ...
  return (     <div
      ...
      role="dialog"
      aria-modal="true"
      aria-label={isEditMode ? "Modificar registro de persona" : "Registrar persona"}
    >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="font-bold text-secondary-900 uppercase">
                      {sexos.find(
                        (s) =>
                          String(s.id) === String(formData.sexo_id),
                      )?.nombre || "—"}{" "}
                      /{" "}
                      {generos.find(
                        (g) =>
                          String(g.id) ===
                          String(formData.genero_id),
                      )?.nombre || "—"}
                    </p>
                  </div>
                  <div className="space-y-0.5">
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="font-bold text-secondary-900 uppercase">
                      {nacions.find(
                        (n) =>
                          String(n.id) ===
                          String(formData.nacion_id),
                      )?.nombre || "—"}
                      {formData.localidad_id && " · "}
                      {localidades.find(
                        (l) =>
                          String(l.id) ===
                          String(formData.localidad_id),
                      )?.nombre || ""}
                    </p>
                  </div>
                  <div className="space-y-0.5">
